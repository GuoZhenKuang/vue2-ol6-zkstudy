 ...
 * @LastEditTime: 2022-03-01 15:03:33
 * @LastEditors: 阿匡
 * @Description: 三维测量功能
 * @FilePath: \vue2-ol-zkstudy\src\components\cesiumDemos\Tool\Measure\index.vue
 * 仅为学习使用
-->
<template>
...
<script>
import executeMixin from '@/components/cesiumDemos/Map3D/mixin/execute3DMixin'
export default {
    name:'simpleTool',
    mixins:[executeMixin],
    data() {
